...
if __name__ == "__main__":
  ...
  jsonFilename = '../../data/'+data+'/intermediate/sentences.json.raw'
  outputfile = '../../data/'+data+'/intermediate/sentences.json'
  ...
  with open(jsonFilename, 'r') as fin, open(outputfile, 'w') as fout:
    ...
    for line in fin:
      ...
      ems_new = []
      for em in ems:
        if em["text"].lower() in eidMap:
          em['entityId'] = eidMap[em["text"].lower()]
          ems_new.append(em)
